...
public class UIManager : MonoBehaviour {
  ...
  public void ToggleEscapeMenu() {
    ...
    if (isEscapeMenuOpen) {
      mainCamera.transform.SetParent(null); // Detach the main camera from its parent
    } else {
      mainCamera.transform.SetParent(transform); // Attach the main camera back to UIManager
    }
  ...
  public void Load() {SaveManager.instance.LoadGame();
